    ...
    public class AirportDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Customer>().HasData(
                new Customer { Id = 1, Email = "user1@example.com", Phone = string.Empty, Username = "user1", PasswordHash = "passhash1", MembershipId = 1 },
                new Customer { Id = 2, Email = "user2@example.com", Phone = string.Empty, Username = "user2", PasswordHash = "passhash2", MembershipId = 2 },
                new Customer { Id = 3, Email = "user3@example.com", Phone = string.Empty, Username = "user3", PasswordHash = "passhash3", MembershipId = 3 });
            ...
            modelBuilder.Entity<FlightTicket>().HasData(
                new FlightTicket { Id = 1, UserId = 1, FlightId = 1, Seat = "12A", Price = 199f, Status = "Booked", PassengerFirstName = "John", PassengerLastName = "Doe", PassengerEmail = "johndoe@example.com", PassengerPhone = string.Empty },
                new FlightTicket { Id = 2, UserId = 2, FlightId = 2, Seat = "14C", Price = 149f, Status = "Booked", PassengerFirstName = "Jane", PassengerLastName = "Roe", PassengerEmail = "janeroe@example.com", PassengerPhone = string.Empty },
                new FlightTicket { Id = 3, UserId = 3, FlightId = 3, Seat = "8F", Price = 249f, Status = "Booked", PassengerFirstName = "Mia", PassengerLastName = "Lane", PassengerEmail = "mialane@example.com", PassengerPhone = string.Empty },
                new FlightTicket { Id = 4, UserId = 1, FlightId = 4, Seat = "5B", Price = 179f, Status = "Booked", PassengerFirstName = "Liam", PassengerLastName = "Stone", PassengerEmail = "liamstone@example.com", PassengerPhone = string.Empty });
