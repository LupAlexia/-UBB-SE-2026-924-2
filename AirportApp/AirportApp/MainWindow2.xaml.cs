...
namespace AirportApp
{
    public sealed partial class MainWindow2 : Window
    {
        ...
        public MainWindow2()
        {
            ...
            authService = App2.AuthService;

            App2.NavigationService.Initialize(ContentFrame);
        ...
        {
            NavigateTo(typeof(Src.View.AuthPage));
        }

        public void NavigateToSearch()
        {
            NavigateTo(typeof(Src.View.FlightSearchPage));
        }

        public void NavigateToDashboard()
        {   
            NavigateTo  (typeof(Src.View.DashboardPage));
        }

        public void NavigateToMemberships()
        {
            NavigateTo(typeof(Src.View.MembershipsPage));
        }
        ...
        private async void TopNav_ItemInvoked(NavigationView sender, NavigationViewItemInvokedEventArgs eventArgs)
        {
            ...
            if (!string.IsNullOrEmpty(navItemTag))
            {
                ...
                if (pageType != null)
                {
                    if (pageType != typeof(Src.View.FlightSearchPage) && UserSession.CurrentUser == null)
                    {
                        NavigateToAuth();
                        return;
                    }
